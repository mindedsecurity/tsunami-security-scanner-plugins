...
/** A Tsunami plugin for detecting CVE-2020-8163. */
@PluginInfo(
    type = PluginType.VULN_DETECTION,
    name = "CVE-2020-8163 Detector",
    version = "0.1",
    description = "TODO.",
    author = "Leonardo Tamiano (leonardo.tamiano@mindedsecurity.com)",
    bootstrapModule = Cve20208163DetectorBootstrapModule.class)
public final class Cve20208163Detector implements VulnDetector {
  ...
  public DetectionReportList detect(
    ...
    logger.atInfo().log("Cve20208163Detector starts detecting.");
